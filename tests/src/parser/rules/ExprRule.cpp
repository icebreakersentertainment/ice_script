#define BOOST_TEST_MODULE ExprRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::exprRule)
    {

    }

    TestParser<ExprRuleType, ExprNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ExprRule)
BOOST_FIXTURE_TEST_SUITE(ExprRule, Fixture)
