#define BOOST_TEST_MODULE LogicopRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::logicopRule)
    {

    }

    TestParser<LogicopRuleType, LogicopNode> parser;
};

//BOOST_AUTO_TEST_SUITE(LogicopRule)
BOOST_FIXTURE_TEST_SUITE(LogicopRule, Fixture)
