#define BOOST_TEST_MODULE LiteralRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::literalRule)
    {

    }

    TestParser<LiteralRuleType, LiteralNode> parser;
};

//BOOST_AUTO_TEST_SUITE(LiteralRule)
BOOST_FIXTURE_TEST_SUITE(LiteralRule, Fixture)
