#define BOOST_TEST_MODULE VirtpropRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::virtpropRule)
    {

    }

    TestParser<VirtpropRuleType, VirtpropNode> parser;
};

//BOOST_AUTO_TEST_SUITE(VirtpropRule)
BOOST_FIXTURE_TEST_SUITE(VirtpropRule, Fixture)
