#define BOOST_TEST_MODULE DowhileRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::dowhileRule)
    {

    }

    TestParser<DowhileRuleType, DowhileNode> parser;
};

//BOOST_AUTO_TEST_SUITE(DowhileRule)
BOOST_FIXTURE_TEST_SUITE(DowhileRule, Fixture)
