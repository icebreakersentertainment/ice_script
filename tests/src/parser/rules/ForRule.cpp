#define BOOST_TEST_MODULE ForRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::forRule)
    {

    }

    TestParser<ForRuleType, ForNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ForRule)
BOOST_FIXTURE_TEST_SUITE(ForRule, Fixture)
