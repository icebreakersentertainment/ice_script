#define BOOST_TEST_MODULE ExprtermRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::exprtermRule)
    {

    }

    TestParser<ExprtermRuleType, ExprtermNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ExprtermRule)
BOOST_FIXTURE_TEST_SUITE(ExprtermRule, Fixture)
