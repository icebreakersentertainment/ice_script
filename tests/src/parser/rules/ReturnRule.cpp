#define BOOST_TEST_MODULE ReturnRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::returnRule)
    {

    }

    TestParser<ReturnRuleType, ReturnNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ReturnRule)
BOOST_FIXTURE_TEST_SUITE(ReturnRule, Fixture)
