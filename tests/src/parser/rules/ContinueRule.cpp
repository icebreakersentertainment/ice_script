#define BOOST_TEST_MODULE ContinueRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::continueRule)
    {

    }

    TestParser<ContinueRuleType, ContinueNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ContinueRule)
BOOST_FIXTURE_TEST_SUITE(ContinueRule, Fixture)
