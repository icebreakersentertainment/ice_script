#define BOOST_TEST_MODULE IdentifierRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::identifierRule)
    {

    }

    TestParser<IdentifierRuleType, IdentifierNode> parser;
};

//BOOST_AUTO_TEST_SUITE(IdentifierRule)
BOOST_FIXTURE_TEST_SUITE(IdentifierRule, Fixture)
