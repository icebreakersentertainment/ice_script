#define BOOST_TEST_MODULE InitlistRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::initlistRule)
    {

    }

    TestParser<InitlistRuleType, InitlistNode> parser;
};

//BOOST_AUTO_TEST_SUITE(InitlistRule)
BOOST_FIXTURE_TEST_SUITE(InitlistRule, Fixture)
