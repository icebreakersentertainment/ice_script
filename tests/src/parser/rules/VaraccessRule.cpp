#define BOOST_TEST_MODULE VaraccessRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::varaccessRule)
    {

    }

    TestParser<VaraccessRuleType, VaraccessNode> parser;
};

//BOOST_AUTO_TEST_SUITE(VaraccessRule)
BOOST_FIXTURE_TEST_SUITE(VaraccessRule, Fixture)
