#define BOOST_TEST_MODULE AssignopRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::assignopRule)
    {

    }

    TestParser<AssignopRuleType, AssignopNode> parser;
};

//BOOST_AUTO_TEST_SUITE(AssignopRule)
BOOST_FIXTURE_TEST_SUITE(AssignopRule, Fixture)
