#define BOOST_TEST_MODULE ConstructcallRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::constructcallRule)
    {

    }

    TestParser<ConstructcallRuleType, ConstructcallNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ConstructcallRule)
BOOST_FIXTURE_TEST_SUITE(ConstructcallRule, Fixture)
