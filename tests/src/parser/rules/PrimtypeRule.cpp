#define BOOST_TEST_MODULE PrimtypeRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::primtypeRule)
    {

    }

    TestParser<PrimtypeRuleType, PrimtypeNode> parser;
};

//BOOST_AUTO_TEST_SUITE(PrimtypeRule)
BOOST_FIXTURE_TEST_SUITE(PrimtypeRule, Fixture)
