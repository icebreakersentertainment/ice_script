#define BOOST_TEST_MODULE NumberRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::numberRule)
    {

    }

    TestParser<NumberRuleType, NumberNode> parser;
};

//BOOST_AUTO_TEST_SUITE(NumberRule)
BOOST_FIXTURE_TEST_SUITE(NumberRule, Fixture)
