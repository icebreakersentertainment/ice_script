#define BOOST_TEST_MODULE BitopRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::bitopRule)
    {

    }

    TestParser<BitopRuleType, BitopNode> parser;
};

//BOOST_AUTO_TEST_SUITE(BitopRule)
BOOST_FIXTURE_TEST_SUITE(BitopRule, Fixture)
