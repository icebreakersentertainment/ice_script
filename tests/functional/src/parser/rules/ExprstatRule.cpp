#define BOOST_TEST_MODULE ExprstatRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::exprstatRule)
    {

    }

    TestParser<ExprstatRuleType, ExprstatNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ExprstatRule)
BOOST_FIXTURE_TEST_SUITE(ExprstatRule, Fixture)
