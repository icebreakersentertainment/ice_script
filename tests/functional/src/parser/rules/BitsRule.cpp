#define BOOST_TEST_MODULE BitsRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::bitsRule)
    {

    }

    TestParser<BitsRuleType, BitsNode> parser;
};

//BOOST_AUTO_TEST_SUITE(BitsRule)
BOOST_FIXTURE_TEST_SUITE(BitsRule, Fixture)
