#define BOOST_TEST_MODULE ExpropRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::expropRule)
    {

    }

    TestParser<ExpropRuleType, ExpropNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ExpropRule)
BOOST_FIXTURE_TEST_SUITE(ExpropRule, Fixture)
