#define BOOST_TEST_MODULE FuncdefRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::funcdefRule)
    {

    }

    TestParser<FuncdefRuleType, FuncdefNode> parser;
};

//BOOST_AUTO_TEST_SUITE(FuncdefRule)
BOOST_FIXTURE_TEST_SUITE(FuncdefRule, Fixture)
