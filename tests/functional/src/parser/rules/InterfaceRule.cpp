#define BOOST_TEST_MODULE InterfaceRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::interfaceRule)
    {

    }

    TestParser<InterfaceRuleType, InterfaceNode> parser;
};

//BOOST_AUTO_TEST_SUITE(InterfaceRule)
BOOST_FIXTURE_TEST_SUITE(InterfaceRule, Fixture)
