#define BOOST_TEST_MODULE ScopeRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::scopeRule)
    {

    }

    TestParser<ScopeRuleType, ScopeNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ScopeRule)
BOOST_FIXTURE_TEST_SUITE(ScopeRule, Fixture)
