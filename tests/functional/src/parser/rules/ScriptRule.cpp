#define BOOST_TEST_MODULE ScriptRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::scriptRule)
    {

    }

    TestParser<ScriptRuleType, ScriptNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ScriptRule)
BOOST_FIXTURE_TEST_SUITE(ScriptRule, Fixture)
