#define BOOST_TEST_MODULE DatatypeRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::datatypeRule)
    {

    }

    TestParser<DatatypeRuleType, DatatypeNode> parser;
};

//BOOST_AUTO_TEST_SUITE(DatatypeRule)
BOOST_FIXTURE_TEST_SUITE(DatatypeRule, Fixture)
