#define BOOST_TEST_MODULE FuncattrRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::funcattrRule)
    {

    }

    TestParser<FuncattrRuleType, FuncattrNode> parser;
};

//BOOST_AUTO_TEST_SUITE(FuncattrRule)
BOOST_FIXTURE_TEST_SUITE(FuncattrRule, Fixture)
