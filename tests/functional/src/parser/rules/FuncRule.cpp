#define BOOST_TEST_MODULE FuncRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::funcRule)
    {

    }

    TestParser<FuncRuleType, FuncNode> parser;
};

//BOOST_AUTO_TEST_SUITE(FuncRule)
BOOST_FIXTURE_TEST_SUITE(FuncRule, Fixture)
