#define BOOST_TEST_MODULE ExprvalueRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::exprvalueRule)
    {

    }

    TestParser<ExprvalueRuleType, ExprvalueNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ExprvalueRule)
BOOST_FIXTURE_TEST_SUITE(ExprvalueRule, Fixture)
