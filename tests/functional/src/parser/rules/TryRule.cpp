#define BOOST_TEST_MODULE TryRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::tryRule)
    {

    }

    TestParser<TryRuleType, TryNode> parser;
};

//BOOST_AUTO_TEST_SUITE(TryRule)
BOOST_FIXTURE_TEST_SUITE(TryRule, Fixture)
