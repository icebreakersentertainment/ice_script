#define BOOST_TEST_MODULE MixinRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::mixinRule)
    {

    }

    TestParser<MixinRuleType, MixinNode> parser;
};

//BOOST_AUTO_TEST_SUITE(MixinRule)
BOOST_FIXTURE_TEST_SUITE(MixinRule, Fixture)
