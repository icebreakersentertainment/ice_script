#define BOOST_TEST_MODULE SwitchRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::switchRule)
    {

    }

    TestParser<SwitchRuleType, SwitchNode> parser;
};

//BOOST_AUTO_TEST_SUITE(SwitchRule)
BOOST_FIXTURE_TEST_SUITE(SwitchRule, Fixture)
