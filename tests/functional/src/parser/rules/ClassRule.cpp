#define BOOST_TEST_MODULE ClassRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::classRule)
    {

    }

    TestParser<ClassRuleType, ClassNode> parser;
};

//BOOST_AUTO_TEST_SUITE(ClassRule)
BOOST_FIXTURE_TEST_SUITE(ClassRule, Fixture)
