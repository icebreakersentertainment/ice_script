#define BOOST_TEST_MODULE CaseRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::caseRule)
    {

    }

    TestParser<CaseRuleType, CaseNode> parser;
};

//BOOST_AUTO_TEST_SUITE(CaseRule)
BOOST_FIXTURE_TEST_SUITE(CaseRule, Fixture)
