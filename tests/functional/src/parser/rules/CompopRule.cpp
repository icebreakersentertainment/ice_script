#define BOOST_TEST_MODULE CompopRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::compopRule)
    {

    }

    TestParser<CompopRuleType, CompopNode> parser;
};

//BOOST_AUTO_TEST_SUITE(CompopRule)
BOOST_FIXTURE_TEST_SUITE(CompopRule, Fixture)
