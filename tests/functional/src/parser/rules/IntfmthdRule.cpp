#define BOOST_TEST_MODULE IntfmthdRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::intfmthdRule)
    {

    }

    TestParser<IntfmthdRuleType, IntfmthdNode> parser;
};

//BOOST_AUTO_TEST_SUITE(IntfmthdRule)
BOOST_FIXTURE_TEST_SUITE(IntfmthdRule, Fixture)
