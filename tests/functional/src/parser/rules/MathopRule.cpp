#define BOOST_TEST_MODULE MathopRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::mathopRule)
    {

    }

    TestParser<MathopRuleType, MathopNode> parser;
};

//BOOST_AUTO_TEST_SUITE(MathopRule)
BOOST_FIXTURE_TEST_SUITE(MathopRule, Fixture)
