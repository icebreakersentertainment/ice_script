#define BOOST_TEST_MODULE LambdaRule
...
struct Fixture
{
    Fixture() : parser(ice_script::parser::rules::lambdaRule)
    {

    }

    TestParser<LambdaRuleType, LambdaNode> parser;
};

//BOOST_AUTO_TEST_SUITE(LambdaRule)
BOOST_FIXTURE_TEST_SUITE(LambdaRule, Fixture)
